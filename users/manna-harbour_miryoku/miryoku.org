...
Alternative base layer alphas are provided. To select, add
...
cd ../.. && make ergodox_ez:manna-harbour_miryoku:flash
#+END_SRC
...
#+BEGIN_SRC sh :tangle no
cd ../.. && make keebio/levinson:manna-harbour_miryoku:flash
#+END_SRC
