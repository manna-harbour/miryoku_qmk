...
Keyboards supporting this layout: a_dux, cradio, ferris/0_1, ferris/0_2, ferris/sweep, obosob/steal_this_keyboard.

Example build command lines:

#+BEGIN_SRC sh :tangle no
make a_dux:manna-harbour_miryoku:flash # a_dux
make cradio:manna-harbour_miryoku:flash # cradio
